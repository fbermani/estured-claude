...
import {
  registerManualFeePayment,
  type RegisterFeePaymentState,
} from "@/app/students/applications/[id]/fee/actions";

const initialState: RegisterFeePaymentState = { status: "idle" };
...
export function FeePaymentForm({ applicationId }: { applicationId: string }) {
  const action = registerManualFeePayment.bind(null, applicationId);
    ...
    return (
      <Card className="mt-6 border-sage-300 bg-sage-50 p-5">
        <p className="text-sm font-medium text-sage-800">
          Comprobante registrado. Nuestro equipo lo va a validar y confirmar tu reserva.
        </p>
      </Card>
    );
  }
  ...
  return (
    <Card className="mt-6 p-6">
      <h2 className="font-bold text-petrol-800">Registrar pago manual</h2>
